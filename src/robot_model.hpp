...
//! RobotModel encapsulates URDF-based kinematics using KDL.
//!
//! Responsibilities:
...
class RobotModel {
public:
  //! Mesh information associated with a link for collision detection.
  struct LinkMesh {
  ...
  //! Construct RobotModel from a URDF file.
  //!
  ...
  bool ik(const KDL::Frame &target, const std::vector<double> &q_seed,
  ...
  void jointLimits(std::vector<double> &lower,
...
private:
  ...
  //! Extract the main kinematic chain and initialize solvers.
