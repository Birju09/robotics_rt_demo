...
- Build a robotics application where robot controller is executing a joint space or cartesian space trajectory.
- Real time loop performs the trajectory and IK calculations.
